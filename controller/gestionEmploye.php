...
if ($op != '') {
    if ($op == 'add') {
        $es->create(new Employe($cin, $nom, $prenom, $email, $telephone, $adresse, md5($password), $role, $photo));
    } elseif ($op == 'update') {
        ...
        $es->update(new Employe($cin, $nom, $prenom, $email, $telephone, $adresse, $password, $role, $photo));
    } elseif ($op == 'delete') {
